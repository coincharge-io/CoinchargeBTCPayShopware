...
Component.register('coincharge-btcpay-generate-key', {
    ...
    methods: {
        generate() {
            ...
            this.isLoading = true;
            return window.open(filteredUrl + '/api-keys/authorize/?applicationName=BTCPay%20Shopware%20plugin&permissions=btcpay.store.cancreateinvoice&permissions=btcpay.store.canviewinvoices&selectiveStores=true&redirect=http://localhost/store-api/btcpay/authorized', '_blank');
