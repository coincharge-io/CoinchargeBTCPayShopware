...
class CoinchargeBTCPayShopware extends Plugin
{
              ...
              [
                ...
                'config' => [
                  'label' => [
                    'en-GB' => 'Crypto Amount',
                    'de-DE' => 'Krypto-Betrag',
                    '2fbb5fe2e29a4d70aa5854ce7ce3e20b' => 'Crypto Amount',
                  ],
                ],
              ],
              [
                ...
                'config' => [
                  'label' => [
                    'en-GB' => 'Exchange Rate',
                    'de-DE' => 'Wechselkurs',
                    '2fbb5fe2e29a4d70aa5854ce7ce3e20b' => 'Exchange Rate',
                  ],
                ],
              ],
  ...
  public function update(UpdateContext $updateContext): void
  {
    ...
    if (
      version_compare($currentVersion, '1.1.1', '=') &&
  ...
  private function ensureMedia(Context $context, string $logoName): string
  {
    ...
    if (!$filePath || !file_exists($filePath)) {
      $this->logger->warning('Icon file not found for: ' . $logoName);
